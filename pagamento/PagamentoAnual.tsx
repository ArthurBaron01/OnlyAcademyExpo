...
const PagamentoAnual: React.FC = () => {
      ...
      items: [
        {
          id: '1234',
          title: 'Plano Anual',
          description: 'Assinatura anual do serviço premium',
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>Assinatura anual do serviço premium</Text>
      <Text style={styles.price}>R$ 168,00</Text>
